...
port = "38053"
database = "railway"  # Aqui você pode usar "railway" ou "mysql" conforme sua necessidade
user = "root"
password = "RtplLlWqZkHCAPXQLnjEclwPGNtGYZDZ"

# Definir uma chave secreta para sessões
app.secret_key = 'sua_chave_secreta_aqui'  # Substitua por uma chave real

# Função para conectar ao banco de dados usando mysql.connector
def connect_db():
    try:
